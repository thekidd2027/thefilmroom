...
const CALLBACK_URL =
  "https://thefilmroom-gules.vercel.app/auth/callback";
...
export default function LoginPage() {
  ...
  async function submit(e: FormEvent) {
    ...
    if (error) {
      ...
      setMsg("Check your email for the Film Room sign-in link.");
    }
    ...
    <div className="min-h-screen grid place-items-center bg-ink p-6">
      ...
      >
        ...
        <input
          ...
          className="w-full bg-bay2 border border-rule rounded-sm px-3 py-2"
        />

        <button disabled={busy} className="btn-go w-full">
